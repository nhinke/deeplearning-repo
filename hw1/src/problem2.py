...
# Experiments includie varying 'k', varying the number of training samples per object class, varying 'p' in the p-norm of the distance metric, etc.
#
